                        ...
                        <div className={`flex-1 w-full min-w-0 pb-12 transition-all duration-500 ease-in-out`}>
                              ...
                              <div className="hidden lg:flex justify-between items-center mb-6 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                                    <div className="flex items-center gap-4">
                                          <Button onClick={clearSearch} variant="danger" size="sm" leftIcon={<FaTimes className="text-white" />}>
                                                {t('search.clear_search', 'Clear Search')}
                                          </Button>
                                          {hasFilters && (
                                                <Button
                              ...
                              {isLoading ? (
                                    ...
                                    <>
                                          ...
                                          <Pagination page={pageNumber} pages={searchData.pages} onPageChange={setPageNumber} />
                                    </>
                              )}
                        </div>
